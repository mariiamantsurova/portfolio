...
export default function App() {
	...
	return (
		<div className="App">
			{showDialog ? (
				<DialogMenu scrollToRef={scrollToRef} aboutRef={aboutRef} skillsRef={skillsRef} contactsRef={contactsRef} closeMenu={closeMenu} />
			) : null}
			<nav className={Styles["nav-bar"]}>
				...
				<div className={Styles["btns-wrapper"]}>
					...
					>
						{paused ? <img src={playBtn} alt="play animation button" /> : <img src={pauseBtn} alt="pause animaion button" />}
					</button>
			...
			<section className={Styles["section-main"]}>
				...
				<Canvas orthographic camera={{ zoom: 1, position: [0, 150, 500] }} className={Styles["canvas"]}>
					<Suspense fallback={null}>
						<ambientLight position={(0, 10, 0)} />
						<spotLight intensity={0.9} angle={0.5} penumbra={0} position={[5, 5, 0]} castShadow />
			...
			<section ref={aboutRef} style={{ minHeight: "100vh" }} className={Styles["section-aboutme"]}>
			...
			<section ref={skillsRef} style={{ MinHeight: "60vh" }} className={Styles["section-skills"]}>
			...
			<section ref={contactsRef} style={{ minHeight: "100vh" }} className={Styles["section-contact"]}>
				<div className={Styles["title-contact"]}>
					<h1>Contact me</h1>
					<h2>Contact me</h2>
				</div>
				<p>if you have any questions or job offer you can contact me on my email or send a message in a form below</p>

				<form target="_blank" action="https://formsubmit.co/marimantsurova@gmail.com" method="POST" className={Styles["form-contact"]}>
