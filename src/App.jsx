		...
		<div className="App">
			...
			<section ref={skillsRef} style={{ MinHeight: "60vh" }} className={Styles["section-skills"]}>
				...
				<ul>
					...
					<li>
						<img src={mongodbIcon} alt="Mongodb Icon" className={Styles["mongodb-icon"]} />
						mongodb
					</li>
			...
			<section ref={contactsRef} style={{ minHeight: "100vh" }} className={Styles["section-contact"]}>
				...
				<form action="https://formsubmit.co/38c8da14c3393708e50870b60ea419fa" method="POST" className={Styles["form-contact"]}>
